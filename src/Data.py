...
#==============================================================================
    ...
    pyplot.plot(Xacc, Yacc[:,DOWN], label="$down$")
    pyplot.plot(Xacc, Yacc[:,FORWARD], label="$forward$")
    pyplot.plot(Xacc, Yacc[:,LEFT], label="$left$")
    pyplot.xlabel("$t$ in $s$")
    pyplot.ylabel("$a$ in $m*s^{-1}$")
    pyplot.legend()
    pyplot.subplot(122)
    ...
    pyplot.plot(Xgyr, intgyr[:,1], label="$roll$")
    pyplot.plot(Xgyr, intgyr[:,2], label="$pitch$")
    pyplot.plot(Xgps[:-1], 
